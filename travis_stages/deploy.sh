...
ssh-add ./deploy_key
ssh -i ./deploy_key -o "StrictHostKeyChecking no" root@janschill.de "docker-compose -f /root/minitwit/docker-compose.yml pull && docker-compose -f /root/minitwit/docker-compose.yml down && docker-compose -f /root/minitwit/docker-compose.yml up -d && docker-compose -f /root/minitwit/logging_elk/docker-compose.yml down && docker-compose -f /root/minitwit/logging_elk/docker-compose.yml up -d"
