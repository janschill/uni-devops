...
ssh-add ./deploy_key
ssh -i ./deploy_key -o "StrictHostKeyChecking no" root@janschill.de "docker-compose -f /minitwit/docker-compose.yml down && docker-compose -f /root/minitwit/docker-compose.yml up -d"
